...
window.addEventListener('DOMContentLoaded', () => { 
 ...
 // Para fade in/out logic
const para = document.getElementById("para");

// Show with same fade-in style as buttons
setTimeout(() => {
    para.classList.add("show");
}, 200);

function fadeAndRemove() {
    para.classList.remove("show"); // triggers fade out
    para.classList.add("fade-out");
    setTimeout(() => para.remove(), 1000); // remove after fade
}

// Auto remove after 5 seconds
const paraTimer = setTimeout(fadeAndRemove, 5000);
